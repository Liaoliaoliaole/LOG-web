...
It's accepting POST and GET requests and make transaction of calibration data between a SDAQ and the WEB. 
...
In case that this script is called without the two required arguments, it will respond with ``HTTP ERROR 404".
