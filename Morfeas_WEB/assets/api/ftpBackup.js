(() => {
  ...
  const ftpBackupApi = {
    ...
    restoreCommit: (file, digest, localConfigDigest, acknowledgeWarnings = false, timeoutMs = 120000) =>
      requestJson('POST', { action: 'restore_commit', file, digest, local_config_digest: localConfigDigest, acknowledge_warnings: acknowledgeWarnings }, null, timeoutMs),
