...
\item \textbf{Revert}: restore the last calibration data loaded into the popup.
...
\item \textbf{Revert}: discard unsaved edits and restore the last data loaded into the popup.
...
\screenshotplaceholder{Calibration Popup}{Insert a screenshot of the current calibration popup showing the top shared section, current preview cards, point table, summary panel, and Read / Revert / Save buttons.}
