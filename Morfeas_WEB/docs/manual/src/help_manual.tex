...
\item \textbf{Current Preview}: \texttt{Reference value}, \texttt{Measured raw value}, and \texttt{Calibrated value}.
...
\begin{itemize}
\item The \textbf{Current Preview} block follows the currently highlighted point row.
\item \texttt{Measured raw value} is taken from the selected row input value.
\item \texttt{Calibrated value} is calculated from the current row coefficients.
